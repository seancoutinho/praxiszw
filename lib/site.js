...
export const contact = {
  ...
  address: {
    line1: '6626 Zimre Way',
    line2: 'Zimre Park, Ruwa',
    city: 'Harare',
    country: 'Zimbabwe',
  },
  addressOneLine:
    '6626 Zimre Way, Zimre Park, Ruwa, Harare, Zimbabwe',
  ...
  mapEmbed:
    'https://www.google.com/maps?q=6626%20Zimre%20Way%2C%20Zimre%20Park%2C%20Ruwa&output=embed',
...
export const services = [
  {
    ...
    seoTitle: 'Tax Management Services in Zimbabwe',
    metaDescription:
      'ZIMRA registration, PAYE, VAT and QPD returns, and representation in queries, objections and audits for Zimbabwean businesses.',
  },
  {
    slug: 'bookkeeping',
    ...
    seoTitle: 'Bookkeeping & Accounting in Zimbabwe',
    metaDescription:
      'Multi-currency bookkeeping, monthly management accounts and year-end financial statements prepared under IFRS or IFRS for SMEs.',
  },
  {
    ...
    seoTitle: 'Business Strategy & Planning Services',
    metaDescription:
      'Budgets, forecasts, cash-flow models and business plans built for a multi-currency, inflation-exposed Zimbabwean market.',
  },
  {
    slug: 'forensic-audit',
    ...
    seoTitle: 'Forensic Audit Services in Zimbabwe',
    metaDescription:
      'Fraud and misappropriation investigations, internal control reviews and evidence-grade reports that hold up in a legal forum.',
  },
  {
    ...
    seoTitle: 'Financial Advisory in Zimbabwe',
    metaDescription:
      'Funding readiness, due diligence, valuations and advice on exchange control and cross-border transactions across the SADC region.',
  },
  {
    ...
    seoTitle: 'Risk & Insurance Strategy Services',
    metaDescription:
      'Risk registers, insurance cover adequacy reviews and claims support, so the balance sheet is protected against real exposures.',
  },
]
