...
const team = [
  {
    ...
    seoTitle: 'Boniface Coutinho, Audit Partner',
    metaDescription:
      'Audit partner at Praxis, ICAZ member, Deloitte-trained, with fifteen years heading a public-sector internal audit function before entering practice.',
    photo: '/assets/images/team/boniface-coutinho.jpg',
    initials: 'BC',
  ...
  },
  {
    ...
    seoTitle: 'Raymond Mupeti, Practice Administration',
    metaDescription:
      'Marketing and administration executive at Praxis, and the first point of contact for new client enquiries and introductory consultations.',
    photo: '/assets/images/team/raymond-mupeti.jpg',
    initials: 'RM',
