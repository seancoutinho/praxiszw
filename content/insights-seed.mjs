/**
 * Praxis Insights — the articles as they stood before the studio existed.
 *
 * SEED DATA ONLY. Insights now live in MongoDB and are edited at /studio.
 * This file is read once by `npm run cms:migrate` and should be deleted once
 * that migration has been verified. Nothing in the app imports it.
 *
 ...
 *
 * Block types understood by components/ui/ArticleBody.js:
 *   { t: 'p'   , c: string }
 *   { t: 'h2' | 'h3', c: string }
...
const insights = [
  /* ------------------------------------------------------------------ 1 */
  {
    slug: 'choosing-business-structure-zimbabwe',
    title: 'Choosing your business structure in Zimbabwe',
    seoTitle: 'Choosing a Business Structure in Zimbabwe',
    metaDescription:
      'Sole proprietorship, partnership, PBC or private limited company — what each form costs you in liability, control and credibility under the COBE Act.',
    excerpt:
    ...
    body: [
      {
        ...
        c: 'Prepared by Praxis Chartered Accountants. Jurisdiction: Zimbabwe. Governing law: the Companies and Other Business Entities Act [Chapter 24:31].',
      },

      { t: 'p', c: 'Every business starts with a decision that gets made once and lived with for years: what legal form should it take? Get it right and the structure fades into the background, quietly doing its job — protecting your personal assets, satisfying a bank or a tender committee, giving you room to bring in a partner or investor later. Get it wrong and you find out at the worst possible moment: when a creditor comes after your personal property, when a tender is rejected on a technicality, or when a good business partnership sours with no paper trail to fall back on.' },
      { t: 'p', c: 'This briefing walks through the main forms available to investors registering a business in Zimbabwe, from the simplicity of trading in your own name to the formality of a private limited company. None of these is universally “best” — the right one depends on how much liability you’re willing to carry personally, how much compliance you’re willing to manage, and who you need to convince: a bank, a government tender board, a co-investor, or simply yourself.' },
      {
        t: 'callout',
        title: 'How to read this',
        c: 'The forms below are ordered from least to most formal. As formality rises, so generally does the cost and administrative burden of running the entity — but so does the protection it offers you, and the doors it opens.',
      },

      { t: 'h2', c: 'Sole proprietorship' },
      { t: 'p', c: 'Trading in your own name, with no legal wall between you and the business.' },
      {
        t: 'callout',
        title: 'At a glance',
        c: 'Legal status: no separate legal personality. Liability: unlimited, personal. Owners required: one. Formation: no Registrar filing required.',
      },
      { t: 'p', c: 'This is the default state of doing business: you simply start trading under your own name or a registered trading name, without incorporating any separate entity. There is no Memorandum, no Articles, no Registrar of Companies filing to bring the business into existence — though you will still need to register with ZIMRA for tax purposes once you begin operating, and register a trading name if you want one.' },
      { t: 'h3', c: 'Advantages' },
      {
        t: 'ul',
        items: [
      ...
      { t: 'h2', c: 'Private Business Corporation (PBC)' },
      { t: 'p', c: 'Limited liability without the full machinery of a company — Zimbabwe’s answer to the small trader who wants protection but not paperwork.' },
      {
        t: 'callout',
        title: 'At a glance',
        c: 'Legal status: separate legal person. Liability: limited to the members’ interest. Members required: 1 to 20 natural persons. Formation: incorporation statement filed with the Registrar.',
      },
      { t: 'p', c: 'The PBC was introduced to formalise the space between the sole trader and the fully-fledged private company, and it has become the second most popular entity registered in Zimbabwe for exactly that reason. Members — who must be individuals, not companies or trusts — both own and manage the PBC directly; there is no separate layer of directors and shareholders, and no requirement to appoint a company secretary. In place of an annual return, a PBC files an annual declaration of continuance. It is governed by PBC By-Laws rather than a Memorandum and Articles.' },
      { t: 'h3', c: 'Advantages' },
      {
        t: 'ul',
        items: [
      ...
      { t: 'h2', c: 'Two further forms worth knowing' },
      { t: 'h3', c: 'Public company limited by shares (PLC)' },
      { t: 'p', c: 'The structure for businesses that intend to raise capital from the public, potentially culminating in a stock exchange listing. It carries no upper limit on the number of shareholders, but comes with materially stricter governance, disclosure, and reporting obligations than a private company. It is rarely the right starting point — most PLCs begin life as a Pvt Ltd and convert once the scale of the business justifies the additional regulatory burden.' },
      { t: 'h3', c: 'Company limited by guarantee' },
      { t: 'p', c: 'Built for non-commercial purposes — charities, professional associations, clubs, and other membership bodies — rather than profit-making ventures. It has no share capital; members instead guarantee a nominal amount payable if the company is wound up. With the Minister’s approval, such a company may drop “Limited” from its name. It is not an appropriate vehicle for a construction business or any enterprise intended to generate a return for its owners.' },
      {
        t: 'callout',
        title: 'A note for foreign investors',
        c: 'If you already operate a company abroad and want a Zimbabwean presence without incorporating a wholly new local entity, registering as an External Company, Branch Office, or Representative Office may be more appropriate than any of the forms above. This is a distinct decision from choosing among local entity types, and worth a separate conversation before you commit to a structure.',
      },

      { t: 'h2', c: 'At a glance: the comparison ledger' },
      { t: 'p', c: 'A side-by-side summary of the four principal forms most investors are choosing between. Requirements are current as at the date of this briefing and are provided for general orientation only.' },
      {
        t: 'table',
        head: ['Feature', 'Sole proprietorship', 'Partnership', 'PBC', 'Pvt Ltd company'],
        rows: [
      ...
      { t: 'verify', c: 'Registration fees, filing costs and the current requirements attaching to each entity type change from time to time. Confirm them with us or with the Companies Registry before acting, and check whether any audit or independent review exemption is actually available to your company.' },

      {
        t: 'callout',
        title: 'Not sure which structure fits your plans?',
        c: 'The right entity depends on your funding plans, your appetite for compliance, and who you need to be credible to — a bank, a tender board, or a future co-investor. Talk to us before you register.',
      },
      {
        t: 'callout',
        title: 'Scope of this briefing',
        c: 'General information only. This briefing summarises the principal business forms available under the Companies and Other Business Entities Act [Chapter 24:31] and is intended to help investors orient themselves before seeking advice. It is not legal, tax, or investment advice, and should not be relied upon as a substitute for a consultation on your specific circumstances. Requirements, fees, and filing obligations are subject to change; please confirm current requirements with us or with the Companies Registry before acting.',
      },
    ],
  },
  ...
  /* ------------------------------------------------------------------ 2 */
  {
    slug: 'ifrs-18-transition-briefing',
    title: 'IFRS 18: what changes in your financial statements from 2027',
    seoTitle: 'IFRS 18 Transition Briefing',
    metaDescription:
      'IFRS 18 replaces IAS 1 for periods beginning 1 January 2027. The new categories and subtotals, MPM disclosure, expense analysis, and what to do during 2026.',
    excerpt:
    ...
    tags: ['IFRS 18', 'IAS 1', 'Financial reporting', 'MPMs', 'Transition'],
    body: [
      {
        t: 'callout',
        title: 'Technical memorandum',
        c: 'To: Finance directors and reporting teams across the Praxis client portfolio. From: Praxis Chartered Accountants — Technical & Advisory Team. Date: 20 August 2026. Re: preparing for IFRS 18, effective for annual periods beginning 1 January 2027.',
      },

      { t: 'h2', c: 'Purpose' },
      { t: 'p', c: 'This memorandum summarises the key changes introduced by IFRS 18 Presentation and Disclosure in Financial Statements, which replaces IAS 1 and becomes mandatory for annual reporting periods beginning on or after 1 January 2027, with restated 2026 comparatives. It is intended to help management understand the scope of change, illustrate the practical impact with worked examples, and set out recommended next steps ahead of the effective date.' },
      { t: 'p', c: 'IFRS 18 does not change how profit or loss is measured. It changes how income and expenses are structured, classified and disclosed — which means every entity reporting under IFRS will be affected, regardless of industry or size.' },

      { t: 'h2', c: 'Summary of key changes' },
      { t: 'p', c: 'IFRS 18 introduces three interlinked sets of requirements.' },

      { t: 'h3', c: 'Three defined categories and two new subtotals' },
      { t: 'p', c: 'The statement of profit or loss must classify all income and expenses into three categories — Operating, Investing and Financing — with income taxes and discontinued operations shown separately. Two new mandatory subtotals appear on the face of the statement:' },
      {
        t: 'ul',
        items: [
      ...
      {
        t: 'callout',
        title: 'Worked example — manufacturing / trading client',
        c: 'Interest earned on a short-term bank deposit, currently shown within “other income” inside operating expenses, must move to the Investing category. Interest paid on a term loan, currently netted within finance costs below an informal “operating profit” line, must be classified in the Financing category and shown below the new mandatory Operating profit subtotal. The result is a cleaner, more comparable Operating profit figure that management can no longer selectively define.',
      },

      { t: 'h3', c: 'Management-defined performance measures (MPMs)' },
      { t: 'p', c: 'Any subtotal of income and expenses that a company uses in public communications to describe financial performance — and that is not one of the subtotals required by IFRS — is now an MPM. MPMs must be disclosed in a single note in the financial statements, reconciled to the most directly comparable IFRS-defined subtotal, with the tax and non-controlling interest effect of each reconciling item and an explanation of why management considers the measure useful.' },
      {
        t: 'callout',
        title: 'Worked example — property development client',
        c: 'A client currently reports “core operating profit” to investors, excluding fair value gains on investment property. Under IFRS 18 this becomes an MPM. The financial statements must include a note reconciling core operating profit back to statutory Operating profit, itemising the fair value adjustment and its related tax effect — disclosure that previously may have appeared only in an investor presentation, not the audited financials.',
      },

      { t: 'h3', c: 'Enhanced aggregation and disaggregation' },
      { t: 'p', c: 'IFRS 18 sets clearer principles for grouping items that share characteristics and separating items that do not, to prevent burying material information inside generic lines such as “other expenses.” Entities that present operating expenses by function on the face of the income statement must now also disclose an analysis by nature in the notes.' },
      {
        t: 'callout',
        title: 'Worked example — microfinance client',
        c: 'A client presenting expenses by function (administration, staff costs by department, and so on) on the face of the statement will now need an accompanying note disaggregating total operating expenses by nature — for example employee benefits, depreciation, and impairment losses on loans — even though the primary statement continues to present by function.',
      },

      { t: 'h2', c: 'A note on classification for lending and investing activities' },
      { t: 'p', c: 'Entities whose main business activity is investing in assets or providing financing to customers — for example, microfinance institutions — apply modified classification rules. Interest income and expense that would ordinarily fall into the Investing or Financing category for other entities is generally classified as Operating for these entities, because it arises from their core business. This distinction should be assessed early, as it directly affects where interest income and expense are presented.' },

      { t: 'h2', c: 'At a glance: IAS 1 versus IFRS 18' },
      {
        t: 'table',
        head: ['Area', 'IAS 1 (current)', 'IFRS 18 (from 2027)'],
        rows: [
          [
            'P&L structure',
            'No mandated categories or subtotals beyond broad guidance',
            'Mandatory Operating / Investing / Financing categories; two new required subtotals',
          ],
          [
            'Adjusted metrics',
            'No formal requirement to reconcile non-IFRS measures in the financial statements',
            'MPMs must be disclosed and reconciled in a dedicated note',
          ],
          [
            'Expense analysis',
            'By function or by nature, entity’s choice, no cross-requirement',
            'If presented by function, a by-nature note is also required',
          ],
          [
            'Comparatives',
            'Standard prior-year comparatives',
            'Full restatement of 2026 comparatives required in 2027 financials',
          ],
        ],
      },

      { t: 'h2', c: 'Recommended next steps' },
      {
        t: 'ul',
        items: [
      ...
      { t: 'h2', c: 'How Praxis can assist' },
      { t: 'p', c: 'Praxis Chartered Accountants can support your transition through a structured IFRS 18 readiness assessment: chart-of-accounts mapping, MPM identification, a dry-run restated income statement, and staff training ahead of the 1 January 2027 effective date. Please contact your engagement partner to schedule a scoping discussion.' },
      {
        t: 'callout',
        title: 'Scope of this memorandum',
        c: 'This memorandum is provided for general guidance to Praxis clients and does not constitute a formal audit opinion or specific accounting advice. Entities should assess IFRS 18 against their own facts and circumstances, and consult their engagement partner before finalising transition decisions.',
      },
    ],
  },
